			   ...
			   mowing_struct* MOW,planting_struct* PLT, ploughing_struct* PLG, thinning_struct* THN, irrigation_struct* IRG)
{
	...
	/* do fertilizing if gapflag=1  - Hidy 2013.*/
	FRZ->mgmd=-1;
	if (FRZ->FRZ_flag)
	{
	...
	/* do grazing if gapflag=1  - Hidy 2013.*/
	GRZ->mgmd=-1;
	if (GRZ->GRZ_flag > 0)
	{
		/* yearly varied (GRZ_flag=2) or constant grazing parameter (GRZ_flag=1) */
	...
	/* do harvesting if gapflag=1  - Hidy 2013.*/
	HRV->mgmd=-1;
	if (HRV->HRV_flag)
	{
		/* yearly varied (GRZ_flag=2) or constant grazing parameter (GRZ_flag=1) */
	...
	/* do mowing if gapflag=1  - Hidy 2013.*/
	MOW->mgmd=-1;
	if (MOW->MOW_flag)
	{
		/* yearly varied (GRZ_flag=2) or constant grazing parameter (GRZ_flag=1) */
	...
	/* do planting if gapflag=1  - Hidy 2013.*/
	PLT->mgmd=-1;
	if (PLT->PLT_flag)
	{
		/* yearly varied (GRZ_flag=2) or constant grazing parameter (GRZ_flag=1) */
	...
	/* do ploughing if gapflag=1  - Hidy 2013.*/
	PLG->mgmd=-1;
	if (PLG->PLG_flag)
	{
		/* yearly varied (GRZ_flag=2) or constant grazing parameter (GRZ_flag=1) */
	...
	/* do thinning if gapflag=1  - Hidy 2013.*/
	THN->mgmd=-1;
	if (THN->THN_flag)
	{
	...
	/* do irrigation if gapflag=1  - Hidy 2015.*/
	IRG->mgmd=-1;
	if (IRG->IRG_flag)
	{
		/* yearly varied (GRZ_flag=2) or constant  parameter (GRZ_flag=1) */
